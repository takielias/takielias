...
1. 💬 Commented on [#82](https://github.com/takielias/tablar/issues/82#issuecomment-2628971955) in [takielias/tablar](https://github.com/takielias/tablar)<br>
2. ✌️ Released [0.13](https://github.com/takielias/laravel-ajax-builder/releases/tag/0.13) in [takielias/laravel-ajax-builder](https://github.com/takielias/laravel-ajax-builder)<br>
3. 🎉 Merged PR [#4](https://github.com/takielias/laravel-ajax-builder/pull/4) in [takielias/laravel-ajax-builder](https://github.com/takielias/laravel-ajax-builder)<br>
4. 💪 Opened PR [#4](https://github.com/takielias/laravel-ajax-builder/pull/4) in [takielias/laravel-ajax-builder](https://github.com/takielias/laravel-ajax-builder)<br>
5. ✌️ Released [0.12](https://github.com/takielias/laravel-ajax-builder/releases/tag/0.12) in [takielias/laravel-ajax-builder](https://github.com/takielias/laravel-ajax-builder)<br>
6. 🎉 Merged PR [#3](https://github.com/takielias/laravel-ajax-builder/pull/3) in [takielias/laravel-ajax-builder](https://github.com/takielias/laravel-ajax-builder)<br>
7. 💪 Opened PR [#3](https://github.com/takielias/laravel-ajax-builder/pull/3) in [takielias/laravel-ajax-builder](https://github.com/takielias/laravel-ajax-builder)<br>
8. ✌️ Released [11.10](https://github.com/takielias/tablar/releases/tag/11.10) in [takielias/tablar](https://github.com/takielias/tablar)<br>
9. 🎉 Merged PR [#81](https://github.com/takielias/tablar/pull/81) in [takielias/tablar](https://github.com/takielias/tablar)<br>
10. 💪 Opened PR [#81](https://github.com/takielias/tablar/pull/81) in [takielias/tablar](https://github.com/takielias/tablar)<br>
<!--RECENT_ACTIVITY:end-->
